...
public class PoiUtil {
	...
	public HSSFCellStyle titlev12(HSSFWorkbook wb, HSSFFont blackFont) {
		...
		curStyle.setVerticalAlignment(VerticalAlignment.CENTER);//文本垂直居中
		return curStyle;
	}
	...
	public HSSFCellStyle nobox(HSSFWorkbook wb) {
		...
		curStyle.setBorderBottom(BorderStyle.THIN);//下边框    
		curStyle.setBorderLeft(BorderStyle.THIN);//左边框    
		curStyle.setBorderTop(BorderStyle.THIN);//上边框    
		curStyle.setBorderRight(BorderStyle.THIN);//右边框
	...
	public HSSFCellStyle moneyrv10_BorderThin(HSSFWorkbook wb, HSSFFont defaultFont10, short rmb4Format) {
		...
		curStyle.setVerticalAlignment(VerticalAlignment.CENTER);//文本垂直居中
		curStyle.setAlignment(HorizontalAlignment.CENTER);//文本水平居中
