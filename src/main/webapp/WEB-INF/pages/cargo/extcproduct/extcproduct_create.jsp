...
<body>
<form id="insertForm" method="post" action="${pageContext.request.contextPath}/api/extcproduct/insert">
    <input type="hidden" name="contract_product_id" value="${contract_product_id}" />
    <div id="menubar">
            ...
            <div id="innerMenubar">
                <div id="navMenubar">
                    <ul>
                        ...
                        <li id="back"><a href="${pageContext.request.contextPath}/api/extcproduct/list?contract_product_id=${contract_product_id}">返回</a></li>
                    </ul>
                </div>
            </div>
        </div>
